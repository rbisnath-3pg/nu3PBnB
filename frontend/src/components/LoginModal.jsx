...
const LoginModal = ({ isOpen, onClose, onLogin, onSwitchToRegister, t }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full mx-4 p-8 relative">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            {t ? t('auth.login.title') : 'Welcome Back'}
          </h2>
          <p className="text-gray-600 dark:text-gray-400">
            {t ? t('auth.login.subtitle') : 'Sign in to your account to continue'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              {t ? t('auth.login.email') : 'Email Address'}
            </label>
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              {t ? t('auth.login.password') : 'Password'}
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            {t ? t('auth.login.noAccount') : "Don't have an account?"}{' '}
            <button
              onClick={onSwitchToRegister}
              className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold transition-colors"
            >
              {t ? t('auth.login.signUp') : 'Sign up'}
            </button>
          </p>
        </div>
      </div>
